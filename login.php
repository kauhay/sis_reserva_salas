			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="assets/img/logo3.png" alt="Aniger"></div>
								<p class="lead">Sistema de Reservas de Salas</p>
							</div>
							<form class="form-auth-small"action="autenticar.php">
								<div class="form-group">
	            <label for="signin-email" class="control-label sr-only">Login</label>
	            <input class="form-control" name="login" id="exampleInputEmail1" type="text" placeholder="Login">
	          </div>
						<div class="form-group">
